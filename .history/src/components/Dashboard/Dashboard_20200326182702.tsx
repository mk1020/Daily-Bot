	...
	async function CreateProject() {
		...
		if (file && projectName) {
			...
			try {
				...
				Storage.remove('protected/eu-central-1:f5fe819a-41bb-4983-a768-248b219d9f4f/fb7cf9f3-07a7-458a-ba4a-2731aff69e3c● App.js - todo-app - Visual Studio Code_001.png', {level: 'protected'})
				updateProjectName('');
				debugger
