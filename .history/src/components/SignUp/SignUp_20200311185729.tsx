			...
			<div className={classes.paper}>
				...
				<form className={classes.form} noValidate>
					<Grid container spacing={2}>
						<Grid item xs={12} sm={6}>
							<TextField
								...
								label="First Name"
								autoFocus
								onChange={e => changeFirstName(e.targer.value)}
								value={firstName}
							/>
						</Grid>
						<Grid item xs={12} sm={6}>
							<TextField
								...
								name="lastName"
								autoComplete="lname"
								onChange={(e: any) => changeLastName(e.targer.value)}
								value={lastName}
							/>
						</Grid>
						<Grid item xs={12}>
					...
					<Button
						...
						onClick={() => changeOnClickSignUp(true)}
					>
						Sign Up
					</Button>
...
export default connect(state => ({null: null}), {
	clickSignUp,
	clickSignIn,
})(SignUp);
